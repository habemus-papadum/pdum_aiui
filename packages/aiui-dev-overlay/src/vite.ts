 ...
 * integration lives at `@habemus-papadum/aiui-viz/vite` now, with two jobs —
...
/** @deprecated Use `aiui()` from `@habemus-papadum/aiui-viz/vite`. */
export function aiuiDevOverlay(options: AiuiDevOverlayOptions = {}): Plugin | Plugin[] {
  console.warn(
    "[aiui] aiuiDevOverlay() is deprecated — use aiui() from @habemus-papadum/aiui-viz/vite " +
