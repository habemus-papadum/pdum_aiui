 ...
 * note in the frozen dev-overlay's handoff/pipeline-and-interaction-model.md
 * — this stream is also the
 ...
 * bytes are handed back for the host to upload as an `intent-v1` attachment
