 ...
 * normal state while driving a multimodal turn — and transport faults
...
export interface IntentError extends IntentErrorInput {
...
export function addError(
  list: readonly IntentError[],
  input: IntentErrorInput,
...
export function dismissError(list: readonly IntentError[], id: number): IntentError[] {
