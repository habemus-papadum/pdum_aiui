<!-- GENERATED at pack time — bundled copy of docs/guide/getting-started.md (the source of truth),
     published at https://habemus-papadum.github.io/pdum_aiui/guide/getting-started. Relative links inside this copy resolve in the source
