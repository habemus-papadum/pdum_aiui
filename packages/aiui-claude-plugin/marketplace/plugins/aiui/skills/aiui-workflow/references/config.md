<!-- GENERATED at pack time — bundled copy of docs/guide/config.md (the source of truth),
     published at https://habemus-papadum.github.io/pdum_aiui/guide/config. Relative links inside this copy resolve in the source
