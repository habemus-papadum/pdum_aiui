<!-- GENERATED at pack time — bundled copy of docs/guide/frontend-for-agents.md (the source of truth),
     published at https://habemus-papadum.github.io/pdum_aiui/guide/frontend-for-agents. Relative links inside this copy resolve in the source
