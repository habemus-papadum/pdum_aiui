<!-- GENERATED at pack time — bundled copy of docs/guide/frontend-user-guide.md (the source of truth),
     published at https://habemus-papadum.github.io/pdum_aiui/guide/frontend-user-guide. Relative links inside this copy resolve in the source
