<!-- GENERATED at pack time — bundled copy of docs/guide/frontend-design-choices.md (the source of truth),
     published at https://habemus-papadum.github.io/pdum_aiui/guide/frontend-design-choices. Relative links inside this copy resolve in the source
