...
// <aiui-scenery>
import { RosePreview } from "./ui/RosePreview";
...
// <aiui-scenery>
// The starter previews the rose; delete this block on reset to fall back to the
// name placeholder above.
card.Preview = RosePreview;
// </aiui-scenery>
