    ...
    <>
      ...
      <div class="app">
        <div class="app-main">
          ...
          <Show when={aztecGraph()} fallback={<p class="app-sub">building dataflow graph…</p>}>
            <section id="the-tiling" class="page-section">
              ...
              <p class="section-lead">
                ...
                freeze into brickwork while a disordered disc churns in the middle. The controls
                drive the growth; the <span class="ctrl">fold</span> scrubber walks it by hand. The
                sections below revisit the arctic circle and the permanent connection with their
                proofs (re-rendering the same live panels).
              </p>
              <div class="layout">
                <div class="col-sim">
                  <AztecCanvas />
            ...
            <section id="the-arctic-circle" class="page-section">
              ...
              <p class="section-lead">
                ...
                dominoes lying outside the circle and matching their corner, climbing toward 1 as
                the diamond grows.
              </p>
              <FrozenChart />
              <p class="prose">
                The <b>Arctic Circle Theorem</b> (Jockusch, Propp &amp; Shor, 1998) makes the
                boundary exact. Rescale AD(n) to the unit square; as <TeX tex="n \to \infty" /> the
                interface between the frozen corners and the disordered disc converges, with
                probability 1, to the inscribed circle — in cell coordinates the circle of radius{" "}
            ...
            <section id="tilings-and-permanents" class="page-section">
              ...
              <p class="section-lead">
                Counting the domino tilings of AD(n) is counting perfect matchings of its dual
                graph, which is the <b>permanent</b> of the black×white biadjacency matrix A — the
            ...
            <section id="experiments" class="page-section">
              ...
              <ul class="experiments">
                ...
                <li>
                  Press <span class="ctrl">regrow</span> at the same{" "}
                  <span class="ctrl">order n</span> to draw a different sample: the frozen corners
                  are fixed by the theorem, but the disordered disc comes out different every time.
                </li>
                <li>
                ...
                <li>
                  Growth is deterministic in its seed: the <span class="ctrl">regrow</span> agent
                  tool accepts a fixed <b>seed</b>, and replaying it reproduces the identical tiling
                  — same disorder, same corners.
                </li>
              </ul>
            </section>
          </Show>
