...
export const targetN = signalBox("aztec:targetN", 32);
export const seed = signalBox<number>("aztec:seed", randomSeed());
export const playing = signalBox("aztec:playing", true);
export const fps = signalBox("aztec:fps", 8);
export const showCircle = signalBox("aztec:showCircle", true);
/** Bumped to force a fresh run (regrow) without changing target/seed. */
export const runId = signalBox("aztec:runId", 0);
/** The playhead: which ring frame is currently painted. */
export const frameIndex = signalBox("aztec:frameIndex", 0);
