    ...
    <>
      ...
      <div class="app">
        <div class="app-main">
          ...
          <Show when={morphoGraph()} fallback={<p class="app-sub">building dataflow graph…</p>}>
            <section id="the-laboratory" class="page-section">
              ...
              <p class="section-lead">
                ...
                through a reactive cell graph. Drag on the field to inject chemical V; click
                anywhere in the atlas, or a catalog row, to travel to a named regime. The sections
                below revisit each panel with the science behind it, re-rendering the same live
                widgets — move a control there and it moves here too.
              </p>
              <div class="layout">
                <div class="col-sim">
                  <SimCanvas />
            ...
            <section id="structure-analysis" class="page-section">
              ...
              <p class="section-lead">
                ...
                connected components (the individual spots) and reports the <b>census</b> — how
                many, their mean area, the largest as a fraction of the field — then computes the
                radial autocorrelation, whose first off-origin peak is the pattern's characteristic{" "}
            ...
            <section id="theory" class="page-section">
              <h2>theory</h2>
              <p class="prose">
                Two chemicals U and V diffuse and react. V catalyses its own production by consuming
                U (the autocatalytic step <TeX tex="U + 2V \to 3V" />
              ...
              <p class="prose">
                ...
                (the <TeX tex="F(1-u)" /> source and part of the <TeX tex="-(F+k)v" /> sink).{" "}
                <b>k</b> is the extra <i>kill</i> rate on V. Together they place the reaction
                between extinction and runaway, and which regime you land in is almost entirely a
                function of the pair (F, k) — which is why the atlas above is a map of behaviour.
              </p>
              <p class="prose">
                ...
                it can suppress it — the short-range activator / long-range inhibitor imbalance
                behind a <b>Turing instability</b>. A spatially uniform steady state, stable against
                uniform perturbations, goes unstable to perturbations at a preferred{" "}
                <i>non-zero wavenumber</i>, so the system spontaneously selects a finite length
                scale — the wavelength λ measured above. It is fixed by the diffusion lengths, not
                the box: the same spacing appears whatever the grid size.
              </p>
            </section>
            ...
            <section id="experiments" class="page-section">
              ...
              <ul class="experiments">
                ...
                <li>
                  With <span class="ctrl">auto</span> on, crank{" "}
                  <span class="ctrl">thoroughness</span> mid-analysis and watch the progress stripe
                  restart — the in-flight worker run is superseded and cancelled, the last result
                  held on screen until the new one lands.
                </li>
                <li>
