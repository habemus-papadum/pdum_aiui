 ...
 * (durable, from @habemus-papadum/aiui-viz), created once and *adopted* by any
 * re-evaluated module.
 *
...
export const paramF = signalBox("param:F", 0.0545);
export const paramK = signalBox("param:k", 0.062);
export const speed = signalBox("param:speed", 12); // sim steps per frame
export const brushRadius = signalBox("param:brush", 0.04); // uv units
export const threshold = signalBox("param:threshold", 0.1); // analysis cutoff
export const quality = signalBox("param:quality", 3); // analysis thoroughness 1..5
export const autoAnalyze = signalBox("param:autoAnalyze", true);
export const failNextFetch = signalBox("param:failNextFetch", false);
...
export const snapshot = signalBox<Snapshot | undefined>("snapshot", undefined);
