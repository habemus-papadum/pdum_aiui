...
Also works without a channel (`pnpm --filter @habemus-papadum/aiui-demo dev`): the app
...
`pnpm run publish` (from this package) builds both notebooks (base `/aiui/`) and dry-runs an
