      ...
      <div class="app-main">
        ...
        <section id="the-tiling" class="page-section">
          ...
          <p class="section-lead">
            ...
            fill the gaps that open up by fair coin flips. Watch the fold — the four corners freeze
            into brickwork while a disordered disc churns in the middle. The controls drive the
            growth; the <span class="ctrl">fold</span> scrubber walks it by hand. The sections below
            revisit the arctic circle and the permanent connection with their proofs (re-rendering
            the same live panels).
          </p>
          <div class="layout">
            <div class="col-sim">
              <AztecCanvas />
        ...
        <section id="the-arctic-circle" class="page-section">
          ...
          <p class="section-lead">
            Away from the centre the tiling freezes: each corner fills with a single domino type in
            perfect brickwork — the <b>frozen</b> (polar) regions. Only a disc in the middle stays
            disordered. The frozen-fraction curve is that fact as a number: the share of dominoes
            lying outside the circle and matching their corner, climbing toward 1 as the diamond
            grows.
          </p>
          <FrozenChart />
          <p class="prose">
            ...
            between the frozen corners and the disordered disc converges, with probability 1, to the
            inscribed circle — in cell coordinates the circle of radius <TeX tex="n/\sqrt{2}" />{" "}
            about the centre:
          </p>
          <TeX display tex="x^2 + y^2 = \frac{n^2}{2}" />
          <p class="prose muted">
            Turn on the arctic-circle overlay and grow n: the dashed circle hugs the frozen boundary
        ...
        <section id="tilings-and-permanents" class="page-section">
          ...
          <p class="section-lead">
            ...
            which is the <b>permanent</b> of the black×white biadjacency matrix A — the determinant
            without the alternating signs:
          </p>
          <TeX
            display
          ...
          />
          <p class="prose">
            That missing cancellation is exactly what makes the permanent <b>#P-hard</b> in general.
            Yet for the Aztec diamond the count collapses to a closed form (EKLP):
          </p>
        ...
        <section id="experiments" class="page-section">
          ...
          <ul class="experiments">
            ...
            <li>
              Compare small vs large <span class="ctrl">order n</span>: at AD(4) the frozen edge is
              ragged; push n up and it sharpens toward the smooth inscribed circle.
            </li>
            <li>
              Toggle the <span class="ctrl">arctic circle</span> overlay and slide{" "}
              <span class="ctrl">order n</span> — the dashed circle of radius n/√2 tracks the frozen
              boundary ever more tightly.
            </li>
            <li>
