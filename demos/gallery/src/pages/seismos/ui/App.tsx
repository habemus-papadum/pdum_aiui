        ...
        <div class="app-main">
          ...
          <section id="the-observatory" class="page-section">
            ...
            <p class="section-lead">
              ...
              histograms; click a depth class or choose an event type — every other view re-counts
              to match, and the stat tiles and the Gutenberg–Richter fit update with them. The
              sections below revisit the data, the cross-filter mechanism, and the law.
            </p>
            <CellView
              of={seismosGraph().dataset}
          ...
          <section id="the-data" class="page-section">
            ...
            <p class="section-lead">
              ...
              type, and an event type. It is U.S. Geological Survey public-domain data (see NOTES.md
              for the exact query and license).
            </p>
            <p class="prose">
              It ships as a single 4.2 MB <b>Parquet</b> file (columnar, ZSTD-compressed) served
              from the site's own origin — no CDN. On load, the file is fetched with a real progress
              bar, handed to an in-browser <b>DuckDB-WASM</b> instance built from locally-bundled{" "}
              ...
              same DuckDB through a connector, pushing every view's aggregation down to the
          ...
          <section id="cross-filtering" class="page-section">
            ...
            <p class="section-lead">
              ...
              the histograms without the map fighting its own filter. The predicates are compiled to
              SQL and run in DuckDB; nothing round-trips to a server.
            </p>
            <p class="prose">
          ...
          <section id="gutenberg-richter" class="page-section">
            ...
            <p class="prose">
              ...
              volcanic and geothermal swarms of many small events. The intercept a measures overall
              productivity. We estimate b by maximum likelihood above the{" "}
            ...
            <p class="prose">
              ...
              region or a time span and watch <b>b</b> re-estimate from just those events. One
          ...
          <section id="experiments" class="page-section">
            ...
            <ul class="experiments">
              ...
              <li>
                ...
                map collapses onto a handful of test sites (Nevada, Novaya Zemlya, Lop Nur, the
                Korean peninsula) — 470 declared blasts hiding in a quarter-million quakes.
              </li>
              <li>
                Brush <span class="ctrl">time</span> to 2004–2005, then 2011: the counts spike with
                the Sumatra–Andaman and Tōhoku aftershock sequences, and the b-value of an
