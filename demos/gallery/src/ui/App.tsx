      ...
      <div class="app-main">
        ...
        <section id="the-laboratory" class="page-section">
          ...
          <p class="section-lead">
            Everything at a glance — the field and its controls, the live observables, the structure
            analysis, and the (F, k) atlas — all reading the one running simulation through a
            reactive cell graph. Drag on the field to inject chemical V; click anywhere in the
            atlas, or a catalog row, to travel to a named regime. The sections below revisit each
            panel with the science behind it, re-rendering the same live widgets — move a control
            there and it moves here too.
          </p>
          <div class="layout">
            <div class="col-sim">
              <SimCanvas />
        ...
        <section id="observables" class="page-section">
          ...
          <p class="section-lead">
            ...
            occupies; <b>contrast</b> is the standard deviation of V — how sharply spots and stripes
            stand out from the background. Watch them settle as a regime locks in, or crash when a
            parameter jump knocks the system off its attractor.
          </p>
          <StatsTiles />
          <TimeSeries />
        </section>
        ...
        <section id="theory" class="page-section">
          ...
          />
          <p class="prose">
            <b>F</b> is the <i>feed</i> rate — how fast fresh U is replenished and V washed out (the{" "}
            <TeX tex="F(1-u)" /> source and part of the <TeX tex="-(F+k)v" /> sink). <b>k</b> is the
            extra <i>kill</i> rate on V. Together they place the reaction between extinction and
            runaway, and which regime you land in is almost entirely a function of the pair (F, k) —
            which is why the atlas above is a map of behaviour.
          </p>
          <p class="prose">
            Because V diffuses slower than U (<TeX tex="D_v < D_u" />; here{" "}
            <TeX tex="D_u = 1,\; D_v = 0.5" />
            ), a local surplus of V builds in place while its inhibitor spreads away faster than it
            can suppress it — the short-range activator / long-range inhibitor imbalance behind a{" "}
            <b>Turing instability</b>. A spatially uniform steady state, stable against uniform
            perturbations, goes unstable to perturbations at a preferred <i>non-zero wavenumber</i>,
            so the system spontaneously selects a finite length scale — the wavelength λ measured
            above. It is fixed by the diffusion lengths, not the box: the same spacing appears
        ...
        <section id="experiments" class="page-section">
          ...
          <ul class="experiments">
            ...
            <li>
              Set <span class="ctrl">speed</span> to <b>paused</b>, then drag on the field with the{" "}
              <span class="ctrl">brush</span> — each stroke lands a single step, so you can paint V
              by hand and seed your own pattern.
            </li>
            <li>
              Hold <span class="ctrl">feed F</span> fixed and slide <span class="ctrl">kill k</span>{" "}
              slowly across ~0.06: you cross the spot ↔ stripe boundary and the whole field
              re-sorts.
            </li>
            <li>
            ...
            <li>
              ...
              <span class="ctrl">re-download</span> to see the cell's error box and its Retry, then
              the table stream back in packet by packet.
            </li>
          </ul>
        </section>
      </div>
