...
the Lens levels-of-detail component — docs/proposals/slides.md is the decided contract; note
the gallery router's head/tail routes and demo-gears' pure `./gear` subpath both exist for this
deck). Each
